...
public class teacher_course_adapter extends ArrayAdapter<Integer> {

    private ArrayList<String> names;
    private ArrayList<String> desc;
    private ArrayList<String> ids;

    public teacher_course_adapter(Context context, ArrayList<String> names, ArrayList<String> desc, ArrayList<String> ids) {
